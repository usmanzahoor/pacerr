...
public class Main extends Activity {
  ...
  private static String address = "00:12:11:24:92:01";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    final String fwd = sharedPreferences.getString("fwd", "");
    final String bwd = sharedPreferences.getString("bwd", "");
    final String rgt = sharedPreferences.getString("rgt", "");
    final String lft = sharedPreferences.getString("lft", "");
    final String stp = sharedPreferences.getString("stp", "");
    ...
    Button b = (Button) findViewById(R.id.config);
